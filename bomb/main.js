...
document.getElementById("newGame").addEventListener("mousedown", function(e) {
        document.getElementById("newGame").style.backgroundPosition = "-56px -80px";
});
...
gameBoard.addEventListener("mousedown", function(e) {
    ...
    if(playing) {
        document.getElementById("newGame").style.backgroundPosition = "-112px -80px";
    }
    showpress(e);
});
...
gameBoard.addEventListener("mouseup", function(e) {
    ...
    if (playing){
        document.getElementById("newGame").style.backgroundPosition = "0px -80px";
    }
});
...
function newGame() {
    ...
    board.style.width = width * 36 + 'px';
    document.getElementById("gameHeader").style.width = (width * 36) + 6 + 'px';

    document.getElementById("newGame").style.backgroundPosition = "0px -80px";
    // equation of a line
    document.getElementById("newGame").style.marginLeft = 0.48177*(width*36)-73 + 'px';
    // 30 tiles = 190px
    // 16 tiles = 60px
    // tile size = 18px
    document.getElementById("wholeGame").style.width = (width * 36) + 6 + 'px';
...
function winGame(){
    ...
    document.getElementById("newGame").style.backgroundPosition = "-224px -80px";
    // redraw board
...
function gameOver(X, Y) {
    ...
    document.getElementById("newGame").style.backgroundPosition = "-168px -80px";
}
